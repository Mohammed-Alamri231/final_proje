...
<body class="hold-transition login-page" style="background:#e9f0fd">
<div class="login-box ">
  <div class="login-logo ">
 
    <a href="{{ url('/home') }}" class="text-center" style="width:150% ;text-left:60% "><b>Mediciens Store </b></a>
    
  </div>
  <!-- /.login-logo -->
  <div class="login-box-body col-md-12 col-md-offset-0 " style=" border-radius:5%">
    <p class="login-box-msg">Sign in to start your session</p>


   @if (session()->has('error'))
<div class ="alert alert-danger text-center" style="font-size:5px">
<h3>{{ session('error') }}</h3>
</div>
