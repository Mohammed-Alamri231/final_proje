        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown notifications-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <span class="label label-warning">{{ count(admin()->user()->unReadNotifications ) }}</span>
            </a>
            <ul class="dropdown-menu">
             @foreach (admin()->user()->unReadNotifications as $note)
             <li>
                <a href="">
                   <li class=""><a href="{{ aurl('bills') }}"><i class="fa fa-tag"></i>{{ $note->data['data'] }}</a></li> 
                    <?php $note->markAsRead() ?>
                </a>
             </li>
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="{{ url('design/adminlte') }}/dist/img/111.jpg" class="user-image" alt="User Image">
          ...
          <!-- Control Sidebar Toggle Button -->
          @if(auth()->guard('admin')->check() && admin()->user()->name=='Fahd Hudnah')
          <li>
