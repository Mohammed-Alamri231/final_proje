...
class Bills_PruDatatable extends DataTable {
	/**
	...
	public function dataTable($query) {
		return datatables($query)
			->addColumn('checkbox', 'admin.bills_pru.btn.checkbox')
			
			->addColumn('delete', 'admin.bills_pru.btn.delete')
